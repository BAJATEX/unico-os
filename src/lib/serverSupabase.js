...
export function serverSupabase() {
  if (!url) throw new Error("Falta SUPABASE_URL (o NEXT_PUBLIC_SUPABASE_URL) en Netlify.");
  if (!secretKey) throw new Error("Falta SUPABASE_SERVICE_ROLE_KEY (o SUPABASE_SECRET_KEY) en Netlify.");
